...
class ModelFreeCollisionDetector():
    """Collision detection in scenes without object labels. Current finger
    width and length are fixed.
    ...
    Example usage:
        ...
        collision_mask, iou_list = mfcdetector.detect(grasp_group, approach_dist=0.03, collision_thresh=0.05,
                                        return_ious=True)
        ...
        collision_mask, empty_mask, iou_list = mfcdetector.detect(grasp_group, approach_dist=0.03,
    ...
    def detect(self,
        ...
        left_right_volume = (heights * self.finger_length * self.finger_width /
